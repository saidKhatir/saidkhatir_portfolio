...
// ajout point champ
 datachamps = 'https://apicarto.ign.fr/api/rpg/v2?annee=2021&geom=%7B%22type%22%3A%20%22Point%22%2C%22coordinates%22%3A%5B-1.7332900936740487%2C48.11449693545512%5D%7D';
    
  jQuery.when( jQuery.getJSON(datachamps)).done(function(json) {
    for (i = 0; i < json.features.length; i++) {
      json.features[i].geometry = json.features[i].geometry;
    }; 
       
map.addLayer(
{'id': 'parcelles_graphiques.9114560',
 'type':'fill',
 'source': {'type': 'geojson','data': json},
...
var popup = new mapboxgl.Popup({lassName: "Mypopuphover",
    closeButton: false,
    closeOnClick: false }); 
...
map.on('click', function (e) {
    ...
    var feature = features[0];
    var popup = new mapboxgl.Popup({className: "Mypopupclick",
    closeButton: false,
    closeOnClick: false, 
    offset: [0, -15]})
